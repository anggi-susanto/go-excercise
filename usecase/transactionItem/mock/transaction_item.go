...
// Source: usecase/transactionItem/interface.go
...
func (m *MockReader) Get(ctx context.Context, id *uint32) (*transaction.TransactionItem, error) {
	...
	ret0, _ := ret[0].(*transaction.TransactionItem)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockUseCase) CreateTransactionItem(ctx context.Context, transactionID, skuID uint32, basePrice, discount float64, qty int) (*transaction.TransactionItem, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTransactionItem", ctx, transactionID, skuID, basePrice, discount, qty)
	ret0, _ := ret[0].(*transaction.TransactionItem)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUseCaseMockRecorder) CreateTransactionItem(ctx, transactionID, skuID, basePrice, discount, qty interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateTransactionItem", reflect.TypeOf((*MockUseCase)(nil).CreateTransactionItem), ctx, transactionID, skuID, basePrice, discount, qty)
}
...
func (m *MockUseCase) GetTransactionItem(ctx context.Context, transactionItemId uint32) (*transaction.TransactionItem, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTransactionItem", ctx, transactionItemId)
	ret0, _ := ret[0].(*transaction.TransactionItem)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUseCaseMockRecorder) GetTransactionItem(ctx, transactionItemId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTransactionItem", reflect.TypeOf((*MockUseCase)(nil).GetTransactionItem), ctx, transactionItemId)
}
...
func (m *MockUseCase) UpdateTransactionItem(ctx context.Context, e *transaction.TransactionItem) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateTransactionItem", ctx, e)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockUseCaseMockRecorder) UpdateTransactionItem(ctx, e interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateTransactionItem", reflect.TypeOf((*MockUseCase)(nil).UpdateTransactionItem), ctx, e)
}
